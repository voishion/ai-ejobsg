    ...
    begin
      ...
      while pos < events.size do
        ...
        begin
          ...
          @logger.debug("insert_sql.length: #{insert_sql.length}")
          @logger.debug("one_sql.length: #{one_sql.length}")
          @logger.debug("@commit_size: #{commit_size}")
          @logger.debug("batch_insert_values_end_pos: #{batch_insert_values_end_pos}")
          @logger.debug("events.size: #{events.size}")
